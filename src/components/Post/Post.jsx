...
import './Post.css';
import { FaThumbsUp, FaComment, FaSmile, FaStickyNote, FaFilm } from 'react-icons/fa';
    ...
    return (
        <div className="post" id={post.id} onClick={onClick}>
            <div className="user-info">
                <img className="user-avatar" src={post.user.avatar} alt={post.user.name} />
            ...
            <div className='add-comment-wrapper'>
                <img className="user-avatar user-avatar_comment" src={post.user.avatar} alt={post.user.name} />
